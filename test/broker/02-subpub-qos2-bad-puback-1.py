...
def helper(port, proto_ver):
    connect_packet = mosq_test.gen_connect("02-subpub-qos2-bad-puback1-helper", keepalive=60, proto_ver=proto_ver)
    connack_packet = mosq_test.gen_connack(rc=0, proto_ver=proto_ver)

    mid = 1
    publish1s_packet = mosq_test.gen_publish("subpub/qos2/bad/puback1", qos=2, mid=mid, payload="message", proto_ver=proto_ver)
...
def do_test(start_broker, proto_ver):
    ...
    connect_packet = mosq_test.gen_connect("subpub-qos2-bad-puback1", keepalive=keepalive, proto_ver=proto_ver)
    connack_packet = mosq_test.gen_connack(rc=0, proto_ver=proto_ver)

    mid = 1
    subscribe_packet = mosq_test.gen_subscribe(mid, "subpub/qos2/bad/puback1", 2, proto_ver=proto_ver)
    suback_packet = mosq_test.gen_suback(mid, 2, proto_ver=proto_ver)

    mid = 1
    publish1r_packet = mosq_test.gen_publish("subpub/qos2/bad/puback1", qos=2, mid=mid, payload="message", proto_ver=proto_ver)
